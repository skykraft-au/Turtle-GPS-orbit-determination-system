...
HD_PWD='C:/Users/DinoColling/GPS_V2.0/GPS_V2.0.runs/fifo_gps_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_gps_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_gps_data.tcl
