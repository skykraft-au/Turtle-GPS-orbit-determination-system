...
HD_PWD='C:/Users/DinoColling/GPS_V2.0/GPS_V2.0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GPS_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GPS_Top.tcl -notrace
