...
HD_PWD='C:/Users/DinoColling/GPS_V2.0/GPS_V2.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GPS_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GPS_Top.tcl
