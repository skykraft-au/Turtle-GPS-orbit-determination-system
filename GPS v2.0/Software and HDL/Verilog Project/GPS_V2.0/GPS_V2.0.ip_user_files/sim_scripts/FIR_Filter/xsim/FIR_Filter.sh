...
#
# Script generated by Vivado on Mon Aug 10 15:17:23 +1000 2026
...
#
# Usage        : FIR_Filter.sh
#                FIR_Filter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                FIR_Filter.sh [-reset_run]
#                FIR_Filter.sh [-reset_log]
#                FIR_Filter.sh [-help]
#
...
# script info
echo -e "FIR_Filter.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./FIR_Filter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L axi_utils_v2_0_9 -L fir_compiler_v7_2_22 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FIR_Filter xil_defaultlib.FIR_Filter xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb FIR_Filter.wdb xsim.dir libdpi.so)
...
Usage: FIR_Filter.sh [-step]\n\
Usage: FIR_Filter.sh [-lib_map_path]\n\
Usage: FIR_Filter.sh [-reset_run]\n\
Usage: FIR_Filter.sh [-reset_log]\n\
Usage: FIR_Filter.sh [-keep_index]\n\
