...
#
# Script generated by Vivado on Tue Jul 21 09:34:33 +1000 2026
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_gps_data.sh
...
#
# Usage        : fifo_gps_data.sh
#                fifo_gps_data.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_gps_data.sh [-reset_run]
#                fifo_gps_data.sh [-reset_log]
#                fifo_gps_data.sh [-help]
#
...
#                script (type 'fifo_gps_data.sh -help' for more information).
#
...
# script info
echo -e "fifo_gps_data.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_gps_data.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fifo_gps_data xil_defaultlib.glbl -o fifo_gps_data_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fifo_gps_data_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fifo_gps_data_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_gps_data_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_gps_data.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_gps_data.sh [-help]\n\
Usage: fifo_gps_data.sh [-step]\n\
Usage: fifo_gps_data.sh [-lib_map_path]\n\
Usage: fifo_gps_data.sh [-reset_run]\n\
Usage: fifo_gps_data.sh [-reset_log]\n\
Usage: fifo_gps_data.sh [-keep_index]\n\
Usage: fifo_gps_data.sh [-noclean_files]\n\n\
