...
#
# Script generated by Vivado on Mon Aug 10 12:43:21 +1000 2026
...
#
# Usage        : DDS_Gen.sh
#                DDS_Gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DDS_Gen.sh [-reset_run]
#                DDS_Gen.sh [-reset_log]
#                DDS_Gen.sh [-help]
#
...
#                script (type 'DDS_Gen.sh -help' for more information).
#
...
# script info
echo -e "DDS_Gen.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DDS_Gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.DDS_Gen xil_defaultlib.glbl -o DDS_Gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./DDS_Gen_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key DDS_Gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DDS_Gen_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DDS_Gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DDS_Gen.sh [-help]\n\
Usage: DDS_Gen.sh [-step]\n\
Usage: DDS_Gen.sh [-lib_map_path]\n\
Usage: DDS_Gen.sh [-reset_run]\n\
Usage: DDS_Gen.sh [-reset_log]\n\
Usage: DDS_Gen.sh [-keep_index]\n\
Usage: DDS_Gen.sh [-noclean_files]\n\n\
